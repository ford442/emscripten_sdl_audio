...
if((pifh.special & 0x01) && (pifh.msglength) && (pifh.msglength <= dwMemLength) &&
   (pifh.msgoffset < dwMemLength-pifh.msglength)){
...
flags=((pifh.cmwt >= 0x215) && (pis.cvt & 4)) ? RS_IT2158 : RS_IT2148;
}
